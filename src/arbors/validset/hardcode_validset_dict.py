...
class IO_Schema(ags.ArgSchema):
    ...
    vs_root = ags.fields.InputDir(
        metadata={"description": "Directory with valid set .mat files"},
        dump_default=r"\\allen\programs\celltypes\workgroups\mousecelltypes\SarahWB\packages\tree_comparison\tree_comparison\data",
    )

    out_file = ags.fields.OutputFile(
        metadata={"description": "Path to output JSON file."},
